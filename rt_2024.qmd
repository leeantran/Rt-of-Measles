...
-   *Dữ liệu để ước tính **R~t~** là từ 30/05/2024, nên R~t~ sẽ được tính từ ngày 13/06/2024 (Do Serial interval có trung bình là 14 ngày). **R~t~ \~ 7.07*** vào 08/06/2024, sau đó giảm dần khi dịch bắt đầu xảy ra (số ca mới xuất hiện liên tục) và cho đến ngày 14/09/2024 (khoảng tuần 36) thì ***R~t~ vẫn lớn hơn 1*** chứng tỏ dịch vẫn đang diễn ra và số ca bệnh có thể vẫn tiếp tục tăng.
